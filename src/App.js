        ...
        <div style={{ display: 'flex' }}>
          ...
          >
            <ul style={{ listStyleType: 'none', padding: 0 }}>
              <li>
                <Link to='/'>Example 0</Link>
              </li>
              <li>
                <Link to='/custom_color'>Example 0.1</Link>
              </li>
              <li>
                <Link to='/lines'>Example 1</Link>
              </li>
              <li>
                <Link to='/area'>Example 1.1</Link>
              </li>
              <li>
                <Link to='/area_opacity'>Example 1.2</Link>
              </li>
              <li>
                <Link to='/max_lines'>Example 1.3</Link>
              </li>
              <li>
                <Link to='/basic'>Example 2</Link>
              </li>
              <li>
                <Link to='/colors'>Example 3</Link>
              </li>
              <li>
                <Link to='/config'>Example 4</Link>
              </li>
              <li>
                <Link to='/test'>Example 5</Link>
              </li>
